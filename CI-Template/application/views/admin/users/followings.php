...
<article class="module width_3_quarter">
	...
	<table cellspacing="0" class="tablelist"> 
		...
		?>
		<tbody>
		<?php if($followings->result_count() > 0): ?>
		<!-- show user list --> 
		<?php
			...
			foreach($followings as $follower):
				$u->get_by_id($follower->follower_id); 
				$odd = !$odd;
	...
	<footer>
		<?php $this->load->view('admin/common/article_paging', array('model'=>'Following', 'paged'=>$followings->paged)); ?>
	</footer>
</article>