...
class DataMapper implements IteratorAggregate {
	...
	* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	public function get_paged($page = 1, $page_size = 50, $page_num_by_rows = FALSE, $info_object = 'paged', $iterated = FALSE)
	{
        ...
        public function get_paged_group($page = 1, $page_size = 50, $page_num_by_rows = FALSE, $info_object = 'paged', $iterated = FALSE)
	{
		// first, duplicate this query, so we have a copy for the query
		$count_query = $this->get_clone(TRUE);
		...
		$count_query->db->ar_select = NULL;
		$count_query->db->ar_orderby = NULL;
		$total = $count_query->where('sender','1000000001')->group_by('message')->get();
	 ...
	 */
        ...
        public function get_paged_iterated_group($page = 1, $page_size = 50, $page_num_by_rows = FALSE, $info_object = 'paged')
	{
		return $this->get_paged_group($page, $page_size, $page_num_by_rows, $info_object, TRUE);
	}
